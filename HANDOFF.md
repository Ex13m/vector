...
**Отправлено окончательно:** 12 изменений ушли на предварительную автопроверку Google (до 13 минут),
после неё — на ревью. Страны: 176 (все).

Что ещё потребовал Play сверх нашего чек-листа, кроме стран и декларации активных служб:
**декларация рекламного идентификатора** (обязательна для targetSdk 33+, живёт внутри мастера
«Безопасность данных» — мастер нужно пройти все 5 шагов и сохранить, иначе числится неполным).
Ответ «Нет» проверен по коду: `AD_ID` отсутствует и в нашем манифесте, и в собранном merged-манифесте
релиза, рекламных и аналитических SDK в зависимостях нет.
